...
@pytest.mark.xfail(reason="Spotlight mock API expect body for PATCH /products/{id} endpoint, which is not standard. Need to find a better solution for testing this endpoint.")
@pytest.mark.asyncio
