...
class DangerousGoodProductInformationCreate(BaseModel):
    ...
    environmentally_hazardous: bool = Field(..., alias="environmentally_hazardous", description="Indicates whether the dangerous good product is environmentally hazardous.")
    gross_weight: float = Field(..., alias="gross_weight", description="The gross weight of the dangerous good product.")
    ...
    product_description: Optional[str] = Field(None, alias="product_description", description="The description of the dangerous good product.")
    product_id: str = Field(..., alias="product_id", description="The unique identifier of the dangerous good product.")
    quantity: float = Field(..., alias="quantity", description="The quantity of the dangerous good product.")
    tunnel_code: str = Field(..., alias="tunnel_code", description="The tunnel code of the dangerous good product.")
    unit: Literal['KG', 'L'] = Field(..., alias="unit", description="The unit of measurement for the quantity of the dangerous good product.")
