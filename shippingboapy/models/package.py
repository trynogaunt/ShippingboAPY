...
class Package(BaseModel):
    ...
    order_item_packages: Optional[list[Any]] = Field(None, alias="order_item_packages", description="A list of order item packages associated with the package.")
    item_lines: Optional[list[Any]] = Field(None, alias="item_lines", description="A list of item lines associated with the package.")
    package_product_histories: Optional[list[Any]] = Field(None, alias="package_product_histories", description="A list of package product histories associated with the package.")
