...
class Product(BaseModel):
    ...
    is_pack: Optional[bool] = Field(False, description="Whether the product is a pack or not.")
    ...
    tax_rate: Optional[float] = Field(None, description="The tax rate for the product, in percentage", gt=0)
