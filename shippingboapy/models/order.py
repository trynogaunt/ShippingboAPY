...
class CarrierService(BaseModel):
    ...
    created_at: Optional[ShippingboDateTime] = Field(None, alias="created_at", description="The date and time when the carrier service was created.")
...
class Shipment(BaseModel):
    ...
    created_at: Optional[ShippingboDateTime] = Field(None, alias="created_at", description="The date and time when the shipment was created.")
    delivery_at: Optional[ShippingboDateTime] = Field(None, alias="delivery_at", description="The date and time when the shipment is expected to be delivered, if applicable.")
    ...
    updated_at: Optional[ShippingboDateTime] = Field(None, alias="updated_at", description="The date and time when the shipment was last updated.")
...
class OrderBase(BaseModel):
    ...
    created_at: Optional[ShippingboDateTime] = Field(None, alias="created_at")
    updated_at: Optional[ShippingboDateTime] = Field(None, alias="updated_at")
    ...
    origin_created_at: Optional[ShippingboDateTime] = Field(None, alias="origin_created_at")
    shipped_at: Optional[ShippingboDateTime] = Field(None, alias="shipped_at")
    closed_at: Optional[ShippingboDateTime] = Field(None, alias="closed_at")
    state_changed_at: Optional[ShippingboDateTime] = Field(None, alias="state_changed_at")
...
class Order(OrderBase):
    ...
    closed_at: Optional[ShippingboDateTime] = Field(None, alias="closed_at", description="The date and time when the order was closed.")
    custom_state: Optional[str] = Field(None, alias="custom_state", description="The custom state of the order, if applicable.")
    earliest_chosen_delivery_at: Optional[ShippingboDateTime] = Field(None, alias="earliest_chosen_delivery_at", description="The earliest delivery date chosen for the order.")
    earliest_delivery_at: Optional[ShippingboDateTime] = Field(None, alias="earliest_delivery_at", description="The earliest delivery date for the order.")
    earliest_shipped_at: Optional[ShippingboDateTime] = Field(None, alias="earliest_shipped_at", description="The earliest shipped date for the order.")
    ...
    latest_chosen_delivery_at: Optional[ShippingboDateTime] = Field(None, alias="latest_chosen_delivery_at", description="The latest delivery date chosen for the order.")
    latest_delivery_at: Optional[ShippingboDateTime] = Field(None, alias="latest_delivery_at", description="The latest delivery date for the order.")
    latest_shipped_at: Optional[ShippingboDateTime] = Field(None, alias="latest_shipped_at", description="The latest shipped date for the order.")
...
class OrderSummary(OrderBase):
    ...
    earliest_delivery_at: Optional[ShippingboDateTime] = Field(None, alias="earliest_delivery_at", description="The earliest delivery date for the order, if applicable.")
    latest_delivery_at: Optional[ShippingboDateTime] = Field(None, alias="latest_delivery_at", description="The latest delivery date for the order, if applicable.")
    earliest_chosen_delivery_at: Optional[ShippingboDateTime] = Field(None, alias="earliest_chosen_delivery_at", description="The earliest delivery date chosen for the order, if applicable.")
    latest_chosen_delivery_at: Optional[ShippingboDateTime] = Field(None, alias="latest_chosen_delivery_at", description="The latest delivery date chosen for the order, if applicable.")
...
class OrderCreate(BaseModel):
    ...
    origin_created_at: ShippingboDateTime = Field(..., alias="origin_created_at", description="The date and time when the order was created in the external system, if applicable.")
