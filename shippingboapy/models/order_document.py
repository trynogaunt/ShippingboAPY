...
class OrderDocumentCreate(BaseModel):
    ...
    type: str = Field(..., alias="type", description="The type of the order document to create (e.g., invoice, packing slip).")
    uploaded_file: int = Field(None, alias="uploaded_file", description="The unique identifier of the uploaded file to associate with the order document, if applicable.")